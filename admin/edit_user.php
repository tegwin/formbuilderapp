...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Update user details
        $stmt = $pdo->prepare("UPDATE users SET name = ?, username = ?, email = ?, role = ?, is_admin = ? WHERE id = ?");
        $stmt->execute([$name, $username, $email, $role, $is_admin, $user_id]);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="name" value="<?= htmlspecialchars((string)$user['name']) ?>" class="form-control">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Username</label>
                        <input type="text" name="username" value="<?= htmlspecialchars((string)$user['username']) ?>" class="form-control" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" value="<?= htmlspecialchars((string)$user['email']) ?>" class="form-control">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check mt-4">
                            <input type="checkbox" name="is_admin" class="form-check-input" id="adminCheck" <?= $user['is_admin'] ? 'checked' : '' ?>>
